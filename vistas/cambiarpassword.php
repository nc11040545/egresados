...
if( $password1 != "" && $password2 != "" && $idregistro != "" && $correo != "" ){
?>
<!DOCTYPE html>
<html lang="es">
  <head>
...
<?php
	...
	if( $resultado->num_rows > 0 ){
		...
		if( sha1( $registro['idregistro'] === $idregistro ) ){
			if( $password1 === $password2 ){
				$sql = "UPDATE registro SET password = '".sha1($password1)."' WHERE id = ".$registro['idregistro'];
