...
<body>
  ...
  <div class="header_blog2">
    <div class="header">
    <h1 id="titulo" align="left" >Directorio</h1><hr>
      </div>
    <div class="clr"></div>
  </div>
<?php
...
if ($q) {
	...
	echo "<tr> <td>".$row ["Nombre"]."</td><td> " .$row ["Paterno"]."</td><td> " .$row ["Materno"]."</td><td> " .$row ["Generacion"]."</td><td> " .$row ["Redes"]."</td><td> " .$row ["Celular"]."</td><td> ";	
   }
   echo "</table>"; 
} 
 else { 
