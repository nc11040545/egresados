...
<body>
	<form id="form-insertar" method="post" action="">
           <div class="contacto">
			   ...
			   <input type="text" onKeyUp="this.value = this.value.toUpperCase();" name="usuario"><br>
          ...
          <script>$(document).on("submit","#form-insertar",function(evento){
			...
			if ($("input[name=nombre]").val()!="" && $("input[name=usuario]").val()!="" && $("input[name=password]").val()!="" &&$("input[name=correo]").val()!=""){
				{
