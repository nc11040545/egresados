...
<body>
  ...
  <div class="clr"></div>
    <h1 id="titulo" align="center" >Gráfica de Tiempo en Conseguir Empleo</h1><hr>
      </div>
    <div class="clr"></div>
  </div>
...
<body>
<div id="tiempo" class="grafica"></div>	
	
<script>
	$.get("tiempo.php",function(jsonData){
		 var plot1 = $.jqplot('tiempo',jsonData,
								{ 
									seriesDefaults: {
...
if ($q) {
	...
	echo "<tr> <td>".$row ["tiempo"]."</td><td> " .$row ["total"]."</td></tr>";	
	$total+=$row ["total"];
	}
