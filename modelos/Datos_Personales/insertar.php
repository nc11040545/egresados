<?php 
	...
	$modificar= $Datos_Personales->altaDatos_Personales($_POST["id"], $_POST["Nombre"], $_POST["Paterno"], $_POST["Materno"], $_POST["Sexo"],$_POST["Telefono"], $_POST["Celular"], $_POST["Direccion"], $_POST["Ciudad"], $_POST["Estado"], $_POST["Carrera"], $_POST["Generacion"], $_POST["Redes"], $_POST["Compartir"]);
